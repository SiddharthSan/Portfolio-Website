            ...
            <div className="timeline">
                <div className="timeline-item">
                    ...
                    <div className="timeline-content narrow">
                        ...
                        <p>
                            Developed widgets for website using JavaScript, HTML, CSS,  and Java.<br /><br />
                            <strong>Key responsibilities:</strong><br /><br />
                            Developed the frontend of the project using React to create
                            dynamic and responsive user interfaces, enhancing user
                            experience through component-based architecture.
                            <br /><br />
